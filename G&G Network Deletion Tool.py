...
#                 {
#                     "report": {
#                         "file": f"Searching file {filename}",
#                         "dir": f"in {dirpath}",
#                     }
#                 },
#             )
...
#         add_message_to_queue(
#             queue,
#             {"report": {"dir": f"Searching {os.path.normpath(folder)}", "file": ""}},
#         )
...
#                         {
#                             "report": {
#                                 "file": f"Searching file: {_dir}",
#                                 "dir": f"in directory: {folder}",
#                             }
#                         },
#                     )
...
#     if "report" in data:
#         eel.progressUpdate(data["report"]["dir"], data["report"]["file"])
...
if __name__ == "__main__":
    ...
    eel.start("index.html", size=(1000, 1000), port=3100)
