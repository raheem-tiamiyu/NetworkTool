...
class FileManager:
    ...
    def search(self, search_keys, specified_columns, target_folders, files_per_page):
        ...
        if len(self.search_keys) == 0:
            return self.error_handler.show_error_message(message="No file was found")
        ...
        return json.dumps(
            {
                ...
                "has_more": len(self.found_files[self.search_keys[0]]) > files_per_page,
            }
        )
    ...
    def show_more_files(self, page, files_per_page):
        ...
        try:
            ...
            return self.error_handler.show_error_message(
                message=f"Couldn't get the rest of the files\n\n{e}"
            )
